...
class ArguxAI {
    ...
    track(eventName, properties = {}) {
        ...
        const event = {
            event_type: eventName,  // Changed from event_name to match API
            session_id: this.sessionId,
            user_id: this.userId,
            timestamp: Date.now(),
            funnel_step: properties.funnel_step || null,
            device_type: deviceType,  // Added at root level for API
            country: 'US',
            app_version: this.metadata.app_version || '1.0.0',
            properties: {
                ...this.metadata,
                ...properties,
